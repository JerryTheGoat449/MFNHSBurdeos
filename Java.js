document.addEventListener("DOMContentLoaded", () => {
  ...
  function hideAllSections() {
    ...
    buttons.forEach((button) => {
      button.style.backgroundColor = "#003366"; // Dark blue background
      button.style.color = "white"; // White text color
      button.style.border = "2px solid #003366"; // Dark blue border
    });
  }
  ...
  function createButton(button, label, section) {
    ...
    button.addEventListener("click", () => {
      ...
      button.style.backgroundColor = "#336699"; // Lighter blue background when active
      button.style.border = "2px solid #336699"; // Lighter blue border when active
    });
